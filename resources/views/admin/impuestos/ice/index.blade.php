<x-admin-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Impuestos ICE</h2>
            <a href="{{ route('admin.impuesto-ices.create') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 px-4 rounded-md text-sm">Nuevo ICE</a>
        </div>
    </x-slot>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($impuestos as $impuesto)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <a href="{{ route('admin.impuesto-ices.edit', $impuesto) }}" class="text-yellow-600 hover:text-yellow-900">Editar</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500">No hay impuestos ICE registrados.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
