<x-admin-layout>
    <x-slot name="header">
        <div class="flex items-center space-x-2">
            ...
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Nuevo Impuesto IRBPNR</h2>
        </div>
    </x-slot>

    <form method="POST" action="{{ route('admin.impuesto-irbpnrs.store') }}" class="max-w-2xl">
        @csrf
        ...
        <div class="bg-white shadow rounded-lg p-6 space-y-6">
            ...
            <div class="flex justify-end">
                ...
                <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 px-6 rounded-md text-sm">Crear IRBPNR</button>
            </div>
        </div>
    </form>
</x-admin-layout>
