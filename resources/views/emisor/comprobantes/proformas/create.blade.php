<x-emisor-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-800">Nueva Proforma</h2>
    ...
    <form method="POST" action="{{ route('emisor.comprobantes.proformas.store') }}" id="proforma-form">
        @csrf
        ...
        <div class="flex justify-end">
            <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700">Guardar Proforma</button>
        </div>
    </form>
