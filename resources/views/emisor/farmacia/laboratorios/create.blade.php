<x-emisor-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-800">Nuevo Laboratorio</h2>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form method="POST" action="{{ route('emisor.farmacia.laboratorios.store') }}">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="pais" value="{{ old('pais') }}" class="w-full border-gray-300 rounded-md shadow-sm text-sm" placeholder="Ej: Ecuador, Colombia, USA...">
            ...
            <div class="flex justify-end mt-6">
                <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700">Crear Laboratorio</button>
            </div>
        </form>
    </div>
</x-emisor-layout>
