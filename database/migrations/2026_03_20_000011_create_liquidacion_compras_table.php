...
return new class extends Migration
{
    ...
    {
        Schema::create('liquidacion_compras', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('liquidacion_detalles', function (Blueprint $table) {
            $table->id();
            $table->foreignId('liquidacion_compra_id')->constrained('liquidacion_compras')->cascadeOnDelete();
        ...
        Schema::create('liquidacion_reembolsos', function (Blueprint $table) {
            $table->id();
            $table->foreignId('liquidacion_compra_id')->constrained('liquidacion_compras')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('liquidacion_reembolsos');
        Schema::dropIfExists('liquidacion_detalles');
        Schema::dropIfExists('liquidacion_compras');
    }
};
